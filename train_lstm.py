...
if __name__ == '__main__':
    train(train_root='../VIVA_avi_group/VIVA_avi_part0/train',train_txt='../VIVA_avi_group/VIVA_avi_part0/gen_train_shuffle.txt',
        valid_root='../VIVA_avi_group/VIVA_avi_part0/val',valid_txt='../VIVA_avi_group/VIVA_avi_part0/val.txt')
